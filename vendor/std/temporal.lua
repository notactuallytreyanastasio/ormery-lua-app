...
Date.methods.encodeToJson = function(this__20, p__91)
  local t_269;
  t_269 = temper.date_tostring(this__20);
  p__91:stringValue(t_269);
  return nil;
end;
Date.decodeFromJson = function(t__94, ic__95)
  local t_270;
  t_270 = temper.cast_to(t__94, JsonString);
  return temper.date_fromisostring(t_270.content);
end;
...
padTo__33 = function(minWidth__43, num__44, sb__45)
  local t_272, t_273, t_274, decimal__47, decimalIndex__48, decimalEnd__49, t_275, nNeeded__50;
  ...
  if temper.stringindexoption_compareto_lt(decimalIndex__48, decimalEnd__49) then
    t_272 = temper.string_get(decimal__47, decimalIndex__48);
    t_274 = (t_272 == 45);
  else
    t_274 = false;
  end
  if t_274 then
    ...
    t_273 = temper.string_next(decimal__47, decimalIndex__48);
    decimalIndex__48 = t_273;
  end
  t_275 = temper.string_countbetween(decimal__47, decimalIndex__48, decimalEnd__49);
  nNeeded__50 = temper.int32_sub(minWidth__43, t_275);
