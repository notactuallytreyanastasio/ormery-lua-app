...
local RegexNode, Capture, CodePart, CodePoints, Special, SpecialSet, CodeRange, CodeSet, Or, Repeat, Sequence, Match, Group, RegexRefs__56, Regex, RegexFormatter__66, Codes__83, Begin__49, return__192, Begin, Dot__50, return__194, Dot, End__51, return__196, End, WordBoundary__52, return__198, WordBoundary, Digit__53, return__200, Digit, Space__54, return__202, Space, Word__55, return__204, Word, buildEscapeNeeds__163, return__1000, escapeNeeds__165, return__1001, regexRefs__164, entire, oneOrMore, optional, exports;
...
RegexRefs__56.constructor = function(this__129, codePoints__548, group__550, match__552, orObject__554)
  local t_276, t_277, t_278, t_279, t_280, codePoints__258, group__259, match__260, orObject__261;
  if temper.is_null(codePoints__548) then
    t_276 = CodePoints('');
    codePoints__258 = t_276;
  else
  ...
  if temper.is_null(match__552) then
    t_278 = temper.map_constructor(temper.listof(temper.pair_constructor('', group__259)));
    t_279 = Match(group__259, t_278);
    match__260 = t_279;
  else
...
Regex.constructor = function(this__57, data__264)
  local t_281, formatted__266, t_282;
  t_281 = data__264;
  this__57.data__262 = t_281;
  formatted__266 = temper.regex_format(data__264);
  t_282 = temper.regex_compileformatted(data__264, formatted__266);
  this__57.compiled__281 = t_282;
  return nil;
end;
...
RegexFormatter__66.methods.pushRegex = function(this__68, regex__315)
  ...
  if temper.instance_of(regex__315, Capture) then
    t_283 = temper.cast_to(regex__315, Capture);
    this__68:pushCapture(t_283);
  elseif temper.instance_of(regex__315, CodePoints) then
    t_284 = temper.cast_to(regex__315, CodePoints);
    this__68:pushCodePoints(t_284, false);
  elseif temper.instance_of(regex__315, CodeRange) then
    t_285 = temper.cast_to(regex__315, CodeRange);
    this__68:pushCodeRange(t_285);
  elseif temper.instance_of(regex__315, CodeSet) then
    t_286 = temper.cast_to(regex__315, CodeSet);
    this__68:pushCodeSet(t_286);
  elseif temper.instance_of(regex__315, Or) then
    t_287 = temper.cast_to(regex__315, Or);
    this__68:pushOr(t_287);
  elseif temper.instance_of(regex__315, Repeat) then
    t_288 = temper.cast_to(regex__315, Repeat);
    this__68:pushRepeat(t_288);
  elseif temper.instance_of(regex__315, Sequence) then
    t_289 = temper.cast_to(regex__315, Sequence);
    this__68:pushSequence(t_289);
...
RegexFormatter__66.methods.pushCapture = function(this__69, capture__318)
  ...
  t_290 = this__69.out__303;
  t_291 = capture__318.name;
  temper.regexformatter_pushcapturename(this__69, t_290, t_291);
  t_292 = capture__318.item;
  this__69:pushRegex(t_292);
  temper.stringbuilder_append(this__69.out__303, ')');
  return nil;
end;
RegexFormatter__66.methods.pushCode = function(this__71, code__325, insideCodeSet__326)
  local return__148, t_293, t_294, t_295, t_296, t_297, t_298, t_299, t_300, t_301, local_302, local_303, local_304;
  ::continue_25::local_302, local_303, local_304 = temper.pcall(function()
    ...
    if (code__325 <= 127) then
      ...
      if temper.generic_eq(escapeNeed__329, 2) then
        ...
        if insideCodeSet__326 then
          t_293 = (code__325 == Codes__83.dash);
        else
          t_293 = false;
        end
        t_294 = t_293;
      ...
      elseif temper.generic_eq(escapeNeed__329, 0) then
        t_296 = temper.string_fromcodepoint(code__325);
        temper.stringbuilder_append(this__71.out__303, t_296);
        return__148 = nil;
        return 'break_24', 'flow';
      end
    end
    if (code__325 >= Codes__83.supplementalMin) then
      ...
      if (code__325 > Codes__83.highControlMax) then
        if (Codes__83.surrogateMin <= code__325) then
          t_297 = (code__325 <= Codes__83.surrogateMax);
        else
          t_297 = false;
        end
        if t_297 then
          ...
          t_298 = (code__325 == Codes__83.uint16Max);
        end
        t_299 = not t_298;
      else
        t_299 = false;
    ...
    if t_300 then
      t_301 = temper.string_fromcodepoint(code__325);
      temper.stringbuilder_append(this__71.out__303, t_301);
    else
...
RegexFormatter__66.methods.pushCodePoints = function(this__73, codePoints__336, insideCodeSet__337)
  local t_306, t_307, value__339, index__340;
  ...
  while true do
    ...
    t_306 = temper.string_get(value__339, index__340);
    this__73:pushCode(t_306, insideCodeSet__337);
    t_307 = temper.string_next(value__339, index__340);
    index__340 = t_307;
  end
  return nil;
end;
...
RegexFormatter__66.methods.pushCodeRangeUnwrapped = function(this__75, codeRange__345)
  local t_308, t_309;
  t_308 = codeRange__345.min;
  this__75:pushCode(t_308, true);
  temper.stringbuilder_append(this__75.out__303, '-');
  t_309 = codeRange__345.max;
  this__75:pushCode(t_309, true);
  return nil;
end;
RegexFormatter__66.methods.pushCodeSet = function(this__76, codeSet__348)
  local t_310, t_311, t_312, adjusted__350;
  ...
  if temper.instance_of(adjusted__350, CodeSet) then
    t_312 = temper.cast_to(adjusted__350, CodeSet);
    if temper.listed_isempty(t_312.items) then
      ...
      while true do
        ...
        if not (i__351 < t_310) then
          break;
        end
        t_311 = temper.list_get(t_312.items, i__351);
        this__76:pushCodeSetItem(t_311);
...
RegexFormatter__66.methods.pushCodeSetItem = function(this__78, codePart__357)
  ...
  if temper.instance_of(codePart__357, CodePoints) then
    t_313 = temper.cast_to(codePart__357, CodePoints);
    this__78:pushCodePoints(t_313, true);
  elseif temper.instance_of(codePart__357, CodeRange) then
    t_314 = temper.cast_to(codePart__357, CodeRange);
    this__78:pushCodeRangeUnwrapped(t_314);
  elseif temper.instance_of(codePart__357, SpecialSet) then
    t_315 = temper.cast_to(codePart__357, SpecialSet);
    this__78:pushRegex(t_315);
  end
  return nil;
end;
RegexFormatter__66.methods.pushOr = function(this__79, or__360)
  ...
  if not temper.listed_isempty(or__360.items) then
    ...
    t_316 = temper.list_get(or__360.items, 0);
    this__79:pushRegex(t_316);
    i__362 = 1;
    while true do
      t_317 = temper.list_length(or__360.items);
      if not (i__362 < t_317) then
        break;
      end
      temper.stringbuilder_append(this__79.out__303, '|');
      t_318 = temper.list_get(or__360.items, i__362);
      this__79:pushRegex(t_318);
...
RegexFormatter__66.methods.pushRepeat = function(this__80, repeat__364)
  local t_319, t_320, t_321, t_322, t_323, t_324, min__366, max__367;
  temper.stringbuilder_append(this__80.out__303, '(?:');
  t_324 = repeat__364.item;
  this__80:pushRegex(t_324);
  temper.stringbuilder_append(this__80.out__303, ')');
  ...
  if t_321 then
    ...
    if t_322 then
      ...
      if t_323 then
        ...
        t_319 = temper.int32_tostring(min__366);
        temper.stringbuilder_append(this__80.out__303, temper.concat('{', t_319));
        if (min__366 ~= max__367) then
          temper.stringbuilder_append(this__80.out__303, ',');
          if not temper.is_null(max__367) then
            t_320 = temper.int32_tostring(max__367);
            temper.stringbuilder_append(this__80.out__303, t_320);
          end
        end
        temper.stringbuilder_append(this__80.out__303, '}');
      end
...
RegexFormatter__66.methods.pushSequence = function(this__81, sequence__369)
  local t_325, t_326, i__371;
  i__371 = 0;
  while true do
    t_325 = temper.list_length(sequence__369.items);
    if not (i__371 < t_325) then
      break;
    end
    t_326 = temper.list_get(sequence__369.items, i__371);
    this__81:pushRegex(t_326);
    i__371 = temper.int32_add(i__371, 1);
  end
  return nil;
end;
RegexFormatter__66.methods.maxCode = function(this__82, codePart__373)
  local return__159, t_327, t_328;
  if temper.instance_of(codePart__373, CodePoints) then
    local value__375;
    t_328 = temper.cast_to(codePart__373, CodePoints);
    value__375 = t_328.value;
    if temper.string_isempty(value__375) then
      ...
      while true do
        ...
        t_327 = temper.string_next(value__375, index__377);
        index__377 = t_327;
      end
...
buildEscapeNeeds__163 = function()
  local t_330, t_331, t_332, t_333, t_334, t_335, t_336, t_337, t_338, t_339, t_340, t_341, t_342, t_343, t_344, t_345, t_346, t_347, t_348, t_349, t_350, t_351, t_352, t_353, t_354, escapeNeeds__381, code__382;
  ...
  while (code__382 <= 127) do
      ...
      if (code__382 == Codes__83.space) then
        ...
        if (code__382 == Codes__83.underscore) then
          ...
          if (Codes__83.digit0 <= code__382) then
            t_330 = (code__382 <= Codes__83.digit9);
          else
            t_330 = false;
          end
          if t_330 then
            ...
            if (Codes__83.upperA <= code__382) then
              t_331 = (code__382 <= Codes__83.upperZ);
            else
              t_331 = false;
            end
            if t_331 then
              ...
              if (Codes__83.lowerA <= code__382) then
                t_332 = (code__382 <= Codes__83.lowerZ);
              else
                t_332 = false;
              end
              t_333 = t_332;
                                ...
                                if (code__382 == Codes__83.squareLeft) then
                                  ...
                                  if (code__382 == Codes__83.squareRight) then
                                    ...
                                    if (code__382 == Codes__83.star) then
                                      ...
                                      t_338 = (code__382 == Codes__83.tilde);
                                    end
                                    t_339 = t_338;
                                  end
                                  t_340 = t_339;
    ...
    temper.listbuilder_add(escapeNeeds__381, t_354);
